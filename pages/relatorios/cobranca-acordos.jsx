...
export default function RelatorioCobrancaAcordos() {
  ...
  async function getAcordoData(id) {
    try {
      const response = await fetch(
        `/api/relatorios/get-acordo-data/?id=${id}`,
        {
          method: "GET",
          headers: {
            Authorization: session?.user?.token,
              ...
              <Tooltip title="Ação" placement="top">
                <IconButton
                  ...
                  onClick={() => {
                    ...
                    getAcordoData(params.row.acordo_id);
                  }}
                >
                  <ListAltIcon />
                </IconButton>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography>
                  {acordoData?.cpf ? (
                    formatarCPFSemAnonimidade(acordoData?.cpf)
                  ) : (
              ...
              >
                ...
                <Typography>
                  {acordoData?.telefone ? (
                    formatarTelefone(acordoData?.telefone)
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
              ...
              >
                ...
                <Typography>
                  {acordoData?.vl_emprestimo ? (
                    formatarReal(parseFloat(acordoData?.vl_emprestimo))
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
              ...
              >
                ...
                <Typography>
                  {acordoData?.vl_capital_giro ? (
                    formatarReal(parseFloat(acordoData?.vl_capital_giro))
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
              ...
              >
                <Typography sx={{ fontWeight: 700 }}>
                  Valor do juros adicional:
                </Typography>
                <Typography>
                  {acordoData?.vl_juros_adicional ? (
                    formatarReal(acordoData?.vl_juros_adicional)
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
              ...
              >
                ...
                <Typography>
                  {acordoData?.dt_acordo ? (
                    formatarData(acordoData?.dt_acordo)
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
              ...
              >
                ...
                <Typography>
                  {acordoData?.dt_cobranca ? (
                    getDiaDaCobranca(acordoData?.dt_cobranca)
                  ) : (
                    <Skeleton height={28} width={120} />
                  )}
                </Typography>
            ...
            {acordoData?.parcelas ? (
              ...
              >
                ...
                >
                  ...
                  <TableBody>
                    {acordoData?.parcelas?.map((parcela, index) => (
                      <TableRow
                        key={index}
                        sx={{
